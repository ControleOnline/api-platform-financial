---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-financial, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-financial`.
...
- Checkout local: `api-community/modules/controleonline/financial`
