...
namespace ControleOnline\Library\Itau\Entity;
...
class Payment
{
  ...
  public function isPromissePaid(): bool
  {
    //return in_array($this->getStatus(), ['paid_waiting_compensation', 'created']);
    return in_array($this->getStatus(), ['paid_waiting_compensation']);
  }
