...
/**
 * Join table: people ↔ paymentType.
 * PaymentType is a catalog; company ownership lives here, not on payment_type.people_id.
 */
#[ORM\Entity]
#[ORM\Table(name: 'people_payment')]
#[ORM\UniqueConstraint(name: 'people_payment_people_type_uidx', columns: ['people_id', 'payment_type_id'])]
#[ApiResource(
    operations: [
